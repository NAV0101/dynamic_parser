...
MiraiTextStyle _$MiraiTextStyleFromJson(Map<String, dynamic> json) {
  return _MiraiTextStyle.fromJson(json);
}

/// @nodoc
mixin _$MiraiTextStyle {
...
/// @nodoc
abstract class $MiraiTextStyleCopyWith<$Res> {
  factory $MiraiTextStyleCopyWith(
          MiraiTextStyle value, $Res Function(MiraiTextStyle) then) =
      _$MiraiTextStyleCopyWithImpl<$Res, MiraiTextStyle>;
  @useResult
  $Res call(
      {bool inherit,
      String? color,
...
/// @nodoc
class _$MiraiTextStyleCopyWithImpl<$Res, $Val extends MiraiTextStyle>
    implements $MiraiTextStyleCopyWith<$Res> {
  _$MiraiTextStyleCopyWithImpl(this._value, this._then);
...
abstract class _MiraiTextStyle implements MiraiTextStyle {
  const factory _MiraiTextStyle(
      {final bool inherit,
      final String? color,
      final String? backgroundColor,
      final double? fontSize,
